...
__all__ = ['povm_gram', 'povm_phi', 'quantumness', 'dm_probs', 'probs_dm', 'conditional_probs', 'quantum_inner_product',
           'tensor_povm', 'upgrade_povm', 'apply_dims', 'SQRTM', 'implement_povm', 'discriminator_povm']
...
def implement_povm(E):
    ...
    V = sum([qt.tensor(SQRTM(E[i]), qt.basis(n, i)) for i in range(n)])
